...
Tổng Hợp Dữ Liệu Có Cấu Trúc Từ Bài Báo Khoa Học cho Sinh Viên mới nghiên cứu.
...
- `_lumina/tools/` — công cụ Python (luôn có: `extract_pdf.py`, `fetch_pdf.py`, `requirements.txt`)
